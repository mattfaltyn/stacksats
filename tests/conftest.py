...
@pytest.fixture
def mock_coinmetrics_response(mocker, sample_coinmetrics_csv):
    """Mock the CoinMetrics CSV fetch."""
    mock_response = MagicMock()
    mock_response.content = sample_coinmetrics_csv.encode("utf-8")
...
def mock_db_with_data(mock_db_connection):
    ...
    mock_cursor.fetchone.return_value = (100,)  # Non-empty table
    return mock_conn, mock_cursor
